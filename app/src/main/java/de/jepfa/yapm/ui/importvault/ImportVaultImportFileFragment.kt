...
class ImportVaultImportFileFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val usernameTemplatesCount = jsonContent.get(VaultExportService.JSON_USERNAME_TEMPLATES_COUNT)?.asString
        ...
        loadedFileStatusTextView.text = getString(R.string.vault_export_info,
            formatAsDateTime(createdAt, requireContext()), credentialsCount, labelsCount, vaultId)
