...
import de.jepfa.yapm.util.getEncryptedSetExtra
import de.jepfa.yapm.util.putEncryptedExtra
import de.jepfa.yapm.util.putEncryptedSetExtra
import java.util.*
...
data class EncCredential(var id: Int?,
                         ...
                         var labels: Set<Encrypted> = Collections.emptySet()) {
    ...
    constructor(id: Int?,
            ...
            this(id,
                ...
                labelsBase64.map { Encrypted.fromBase64String(it) }.toSet())
    ...
    fun applyExtras(intent: Intent) {
        ...
        intent.putEncryptedSetExtra(EXTRA_CREDENTIAL_LABELS, labels)
    }
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent): EncCredential {
            ...
            val encLabels = intent.getEncryptedSetExtra(EXTRA_CREDENTIAL_LABELS)
